...
const footerLinks = {
  ...
  Resources: ["Community", "Help Center", "Status", "API", "Templates"],
...
export const Footer = () => {
  return (
    <footer id="contact" className="py-16 md:py-24 border-t border-border relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm mb-6 max-w-xs">
              Build products that scale with you. The all-in-one platform for modern teams.
            </p>
            {/* Social Links */}
